...
Browser-based Portfolio OS built with Next.js.

## Folders

- `docs/`: project documentation, roadmap, and style rules.
- `public/`: static assets served directly by Next.js.
- `src/`: application source code, runtime layers, and app modules.
