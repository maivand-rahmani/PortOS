...
- `use-desktop-selection.ts`: macOS-style multi-selection hook with Cmd+toggle, Shift+range, and click-to-select behaviors backed by `desktopSelections: string[]`.
