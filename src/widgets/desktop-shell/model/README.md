...
The shell model now also owns shell-level launch flows such as opening the AI agent with guided prompts from the desktop teaser and cycling running apps through the app switcher overlay.
